...
import "contracts/contract/megapool/RocketMegapoolPenalties.sol";

contract RocketMegapoolPenaltiesInvariantTest is Test {
    RocketMegapoolPenalties target;

    function setUp() public {
        target = new RocketMegapoolPenalties(RocketStorageInterface(address(0x1)));
    }
