...
import "contracts/contract/rewards/RocketMerkleDistributorMainnet.sol" as Target;

contract RocketMerkleDistributorMainnetInvariantTest is Test {
    Target.RocketMerkleDistributorMainnet target;

    function setUp() public {
        target = new Target.RocketMerkleDistributorMainnet();
    }
