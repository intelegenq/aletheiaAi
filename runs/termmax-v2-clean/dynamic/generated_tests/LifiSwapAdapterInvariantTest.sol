...
import "contracts/v2/router/swapAdapters/LifiSwapAdapter.sol";

contract LifiSwapAdapterInvariantTest is Test {
    LifiSwapAdapter target;

    function setUp() public {
        target = new LifiSwapAdapter(address(0x1));
    }
